...
**Import and conversion services for external lot-sizing data formats.**

## Role in the solution

This component is part of the [**LotSizingDataModel**](../index.html) solution and is classified as **Library**.
