...
**Automated test suite for checker components and regression behavior.**

## Role in the solution

This component is part of the [**LotSizingDataModel**](../index.html) solution and is classified as **Tests**.
