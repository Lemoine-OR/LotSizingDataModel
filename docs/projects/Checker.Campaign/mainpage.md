...
**Batch regression-campaign orchestration for the solution checker.**

## Role in the solution

This component is part of the [**LotSizingDataModel**](../index.html) solution and is classified as **Tooling**.
