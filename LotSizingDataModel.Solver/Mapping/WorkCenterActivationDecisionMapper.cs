...
/// <summary>
/// Maps mathematical work-center activation values to work-center
/// capacity decisions in a lot-sizing solution.
/// </summary>
/// <remarks>
/// Expected canonical domain-key format:
/// <code>
/// workCenterActivation|plant=&lt;id&gt;|workCenter=&lt;id&gt;|period=&lt;index&gt;
/// </code>
/// Period numbers are one-based.
/// </remarks>
public sealed class WorkCenterActivationDecisionMapper :
    MathematicalDecisionMapperBase
{
    ...
    /// <summary>
    /// Maps one non-zero work-center activation value.
    /// </summary>
    /// <param name="context">
    ...
    /// Parsed work-center activation domain key.
    /// </param>
