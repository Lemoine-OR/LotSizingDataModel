...
/// <summary>
/// Maps mathematical safety-stock violation values to inventory
/// decisions in a lot-sizing solution.
/// </summary>
/// <remarks>
/// Supported canonical domain-key formats are:
/// <code>
/// inventorySafetyStockViolation|item=&lt;id&gt;|warehouse=&lt;id&gt;|period=&lt;index&gt;
/// inventorySafetyStockViolation|item=&lt;id&gt;|plant=&lt;id&gt;|period=&lt;index&gt;
/// </code>
...
/// </remarks>
public sealed class InventorySafetyStockViolationDecisionMapper :
    MathematicalDecisionMapperBase
{
    ...
    /// <summary>
    /// Maps one non-zero safety-stock violation value.
    /// </summary>
    /// <param name="context">
    ...
    /// Parsed safety-stock violation domain key.
    /// </param>
    /// <param name="variableValue">
    /// Safety-stock violation returned by the solver.
    /// </param>
        ...
        MathematicalVariableValue variableValue)
    {
        ...
        decision.SetSafetyStockViolation(
            period,
            variableValue.Value);
    }
        ...
        MathematicalDomainKey domainKey)
    {
        ...
        {
            throw new InvalidOperationException(
                "An inventory safety-stock violation domain key " +
                "must identify exactly one warehouse using either " +
                "'warehouse' or 'plant'.");
        }
