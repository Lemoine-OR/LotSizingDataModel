...
/// <summary>
/// Maps mathematical additional transport-resource capacity values
/// to transport-resource capacity decisions in a lot-sizing
/// solution.
/// </summary>
/// <remarks>
/// Expected canonical domain-key format:
/// <code>
/// transportResourceAdditionalCapacity|transportResource=&lt;id&gt;|period=&lt;index&gt;
/// </code>
/// Period numbers are one-based.
/// </remarks>
public sealed class TransportResourceAdditionalCapacityDecisionMapper :
    MathematicalDecisionMapperBase
{
    ...
    /// <summary>
    /// Maps one non-zero additional transport-resource capacity
    /// value.
    /// </summary>
    /// <param name="context">
    ...
    /// Parsed transport-resource additional-capacity domain key.
    /// </param>
