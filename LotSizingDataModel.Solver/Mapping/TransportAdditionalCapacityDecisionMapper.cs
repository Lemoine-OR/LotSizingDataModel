...
/// <summary>
/// Maps mathematical item-specific additional transport-capacity
/// values to transport decisions in a lot-sizing solution.
/// </summary>
/// <remarks>
/// Expected canonical domain-key format:
/// <code>
/// transportAdditionalCapacity|item=&lt;id&gt;|transportResource=&lt;id&gt;|originWarehouse=&lt;id&gt;|destinationWarehouse=&lt;id&gt;|period=&lt;index&gt;
/// </code>
...
/// </remarks>
public sealed class TransportAdditionalCapacityDecisionMapper :
    MathematicalDecisionMapperBase
{
    ...
    /// <summary>
    /// Maps one non-zero item-specific additional transport
    /// capacity value.
    /// </summary>
    /// <param name="context">
    ...
    /// Parsed additional transport-capacity domain key.
    /// </param>
    /// <param name="variableValue">
    /// Additional transport-capacity value returned by the
    /// solver.
    /// </param>
        ...
        string role)
    {
        ...
        {
            throw new InvalidOperationException(
                $"A transport additional-capacity domain key " +
                $"must identify exactly one {role} warehouse " +
                $"using either '{warehouseSegment}' or " +
                $"'{plantSegment}'.");
        }
