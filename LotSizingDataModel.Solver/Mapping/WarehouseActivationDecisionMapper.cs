...
/// <summary>
/// Maps mathematical warehouse-activation values to warehouse
/// capacity decisions in a lot-sizing solution.
/// </summary>
/// <remarks>
/// Supported canonical domain-key formats are:
/// <code>
/// warehouseActivation|warehouse=&lt;id&gt;|period=&lt;index&gt;
/// warehouseActivation|plant=&lt;id&gt;|period=&lt;index&gt;
/// </code>
...
/// </remarks>
public sealed class WarehouseActivationDecisionMapper :
    MathematicalDecisionMapperBase
{
    ...
    /// <summary>
    /// Maps one non-zero warehouse activation value.
    /// </summary>
    /// <param name="context">
    ...
    /// Parsed warehouse-activation domain key.
    /// </param>
        ...
        MathematicalDomainKey domainKey)
    {
        ...
        {
            throw new InvalidOperationException(
                "A warehouse-activation domain key must identify " +
