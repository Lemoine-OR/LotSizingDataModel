...
/// with a transport resource.
/// </summary>
public sealed partial class TransportResource :
    IPlanningHorizonAware
{
    ...
    /// for the transport resource during each planning period.
    ///
    /// A null value means that no global capacity constraint
    /// is active for this transport resource.
    /// </summary>
    ...
    /// be allocated to the transport resource during each period.
    ///
    ...
    /// resource is used during a planning period.
    /// </summary>
    ...
    /// transport capacity during each planning period.
    ///
    ...
    /// the capacity-related parameters are respected.
    /// </summary>
    [XmlIgnore]
    ...
    /// this transport resource.
    ///
    /// The transport lanes are preserved.
    /// </summary>
