...
/// <summary>
/// One explicitly declared objective criterion.
/// </summary>
[Serializable]
[XmlType(TypeName = "optimizationObjectiveCriterion")]
public sealed class OptimizationObjectiveCriterion : ModelObject
{
        ...
        set
        {
            if (!double.IsFinite(value) || value < 0.0)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(value),
                    value,
                    "Objective criterion weight must be finite and non-negative.");
            }
        ...
        set
        {
            if (value < 0)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(value),
                    value,
                    "Objective criterion priority cannot be negative.");
            }
